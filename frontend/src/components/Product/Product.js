            ...
            >
              <li>
                <div className="flex items-center">
                  ...
                  >
                    {selectedProduct.subcategoryInfo.title}
                  </a>
                  <svg
                    width={16}
                    height={20}
                  ...
                  selectedColor
                    ? `/static/images/${
                        selectedProduct.images.find(
                          (image) => image.color__title === selectedColor
                        ).image
                      }`
                    : `/static/images/${selectedProduct.images[0].image}`
                  // `/static/images/${currentImage.image}`
                }
                ...
                >
                  ...
                  <div className="flex items-center space-x-3">
                    {selectedProduct.images.map((image) => (
                      <RadioGroup.Option
                        key={image.color__title}
                        value={image.color__title}
                        style={{ backgroundColor: image.color__title }}
                      ...
                      >
                        ...
                        <span
                          aria-hidden="true"
                          style={{
                            backgroundColor: image.color__title,
                          }}
